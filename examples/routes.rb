...
# Examples of route definitions, helpers and special route methods
#
...
#        foos.destroy {}
#
#        # For each of the helper methods, and any generic method (eg foos.get) that specifies the :id
